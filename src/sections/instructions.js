...
const instructions_text = [
    display(
        center_text("Welcome!") + hint()
    ),
    display(
        center_text("Please move your mouse to the edge of your screen, so that is no longer visible.") + hint(true)
    ),
    display(
    ...
    display(
        center_text("There are four possible letters you can encounter: <br>'A' or 'F', and 'S' or 'H'")
        + hint(true)
    ),
    display(
    ...
    // Show-case
    display(
        center_text("You will now see all the possible combinations of letters and responses.")
        + hint(true)
    ),
    display(
